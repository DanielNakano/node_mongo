...
class vendas{
    ...
    async ExcluirVenda(id){
        ...
        const result = await db.exluirVenda(id)
...
/* test field 
//golden
const venda = new vendas('14/05/25', 'daniel', '22')

venda.CriarVenda(venda)
venda.BuscarVendaData('14/05/25')
venda.BuscarVendaCliente('daniel')
venda.ExcluirVenda('14/05/25', 'daniel')

//evil
venda.CriarVenda('', 'raquel', 'teste')
venda.BuscarVendaCliente('raquel')
venda.BuscarVendaData('')
venda.ExcluirVenda('', 'raquel')
*/