    ...
    async CriarCompra(compra) {
        if (await this.validarDados(compra)) {
            ...
            if (result) {
                ...
                console.log("Houve algum problema no registo da compra  tente novamente")
...
const compra = new Compras('15/02/28', 'rafael', 'teste')
compra.buscaData('15/05/28')
//compra.CriarCompra(compra)
//compra.deletarcompra('15/02/28', 'daniel')
